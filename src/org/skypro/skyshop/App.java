...
public class App {
    public static void main(String[] args) {
        ...
        Product p2 = new Product("Молоко", 80);
        Product p3 = new Product("Яблоки", 120);
        Product p4 = new Product("Сыр", 200);
        Product p5 = new Product("Колбаса", 300);
        Product p6 = new Product("Сок", 150);
